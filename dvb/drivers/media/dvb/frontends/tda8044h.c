				  ...
				  fe_code_rate_t fec_inner)
{
	...
	/* handle other symbol rates now. nobody knows exactly where those
	   values come from, probably some kind soul did find them empirically */
 ...
 end_write:
	tda8044_write_buf(state, clkbuf, sizeof(clkbuf));
