...
#include <avia/avia_gt.h>
#include <avia/avia_gt_accel.h>
#include <avia/avia_gt_dmx.h>
#include <avia/avia_gt_ucode.h>
#include <avia/avia_gt_vbi.h>
...
int __init avia_gt_napi_init(void)
{
	...
	adapter = dbox2_napi_get_adapter();
...
MODULE_DESCRIPTION("dbox2 DVB demux driver");
