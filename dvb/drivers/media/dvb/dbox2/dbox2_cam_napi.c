...
int cam_napi_init(void)
{
	...
	printk(KERN_INFO "$Id: dbox2_cam_napi.c,v 1.1.2.1 2005/01/31 03:04:12 carjay Exp $\n");

	if ((result = dvb_register_device(dbox2_napi_get_adapter(), &ca_dev, &cam_napi_dev, NULL, DVB_DEVICE_CA)) < 0)
