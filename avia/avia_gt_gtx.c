 ...
 *
 *   $Log: avia_gt_gtx.c,v $
 *   Revision 1.17.6.1  2003/07/02 15:56:41  ghostrider
 *   add lucgas enigma image driver to cvs
 *
 *   Revision 1.7  2003/06/21 15:22:18  dkey
...
void avia_gt_gtx_init(void)
{
	...
	printk("avia_gt_gtx: $Id: avia_gt_gtx.c,v 1.17.6.1 2003/07/02 15:56:41 ghostrider Exp $\n");
