 ...
 *
 *
 *   $Revision: 1.141.2.1.4.1 $
 *   $Log: avia_gt_napi.c,v $
 *   Revision 1.141.2.1.4.1  2003/07/02 15:56:41  ghostrider
 *   add lucgas enigma image driver to cvs
 *
 *   Revision 1.3  2003/06/21 15:22:18  lucgas
...
int __init avia_gt_napi_init(void)
{
	...
	printk("avia_gt_napi: $Id: avia_gt_napi.c,v 1.141.2.1.4.1 2003/07/02 15:56:41 ghostrider Exp $\n");
