 ...
 *   Revision 1.38.2.4.2.1  2003/07/02 15:56:41  ghostrider
...
int __init avia_gt_fb_init(void)
{
    ...
    printk("avia_gt_fb: $Id: avia_gt_fb_core.c,v 1.38.2.4.2.1 2003/07/02 15:56:41 ghostrider Exp $\n");
