/*
 * $Id: saa7126_core.c,v 1.26.6.1 2003/07/02 15:57:12 ghostrider Exp $
 * 
...
// YUV-support added, removed this fucking dynamic stuff - all registers are setup statically, which will save CPU-usage
